        ...
        public override void Run()
        {
            ...
            for (int day = 0; day < DaysPerYear; ++day)
            {
                ...
                if (numRxSites > 0 &&
                    ...
                    ((day >= Parameters.RxFirstDayFire && day < Parameters.RxLastDayFire) ||
                     (day >= Parameters.RxFirstDayFire_2 && day <Parameters.RxLastDayFire_2))
                    ) // KM + KJ adding bimodal rx season
